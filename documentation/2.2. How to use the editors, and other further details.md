...
If you have done all these you now can initialize the animation from this .txt file with the initNewAnimation function. For an example of a parseable animation file check out the animation .txt of the intro animation, this animation for example has 24 rows and 80 columns in each of its 220 frames, and this information can be clearly seen from the file's first three lines.
