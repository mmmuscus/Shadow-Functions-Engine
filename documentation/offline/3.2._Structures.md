...
**Notes:** In version 2.0.3. isPlayer is not dynamically used by the engine, further information can be found [here](2.2._How_to_use_the_editors,_and_other_further_details.md/#2211-how-to-use-the-fov-editors).
