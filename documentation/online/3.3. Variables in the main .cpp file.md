...
**Notes:** This information is needed to make the rendering run smoother and faster, for information about the mob structure click [here](https://github.com/mmmuscus/Shadow-Functions-Engine/blob/master/documentation/online/3.2.%20Structures.md/#321-mob).
