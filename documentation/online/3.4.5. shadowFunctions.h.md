...
As of 2.0.0. this function causes a small bug that makes the shadows behave in weird ways at the edges of the screen as seen in the picture below. It is most probably caused by a mistake in the if statement. The fix for this bug will hopefully be done before the next big release (3.0.0.). 
