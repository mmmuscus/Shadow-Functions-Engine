...
As of 2.0.0. this function causes a small bug that makes the shadows behave in weird ways at the edges of the screen as seen in the picture above. The fix for this bug is already in the works and hopefully it will be done before the next big release (3.0.0.). 
