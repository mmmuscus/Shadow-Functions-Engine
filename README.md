...
Right now this system has a small bug, which I will discuss in [a later section of the documentation](https://github.com/mmmuscus/Shadow-Functions-Engine/blob/master/documentation/3.4.5.-shadowFunctions.h.md/#34512-shadowfunction). Besides the minimum goal I created basic text file based level and field of view editors. I also created the option to make new characters that could block light, or player movement.
